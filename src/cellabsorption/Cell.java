...
public class Cell {
    private static final double WIGGLINESS = 0.2, WANDER_FROM_CENTER = 60000;
    ...
    /**
     * Causes this cell to interact with the other given cell. If the two cells overlap and both have a
     * positive radius, then the larger cell absorbs area from the smaller cell so that the total area
     * is the same, but the two cells are now tangent.
     */
